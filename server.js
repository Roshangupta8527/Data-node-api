...
app.get("/list", (request, response) => {
    var sqlQuery = `SELECT * FROM Roshan_Gupta`;
...
*/
  ...
  app.post("/create",(request,response) => {
    ...
    var sqlQuery = `INSERT INTO Roshan_Gupta (name, age, location, email, blood_group) VALUES ('${name}', ${age}, '${location}', '${email}', '${blood_group}')`;
...
app.put("/edit/:id", (request, response) => {
  ...
  var sqlQuery = `UPDATE Roshan_Gupta SET name='${name}', age=${age}, location='${_location}', email='${email}', blood_group='${blood_group}' WHERE id=${id}`;
...
app.delete("/delete/:id", (request, response) => {
  ...
  var sqlQuery = `DELETE FROM Roshan_Gupta WHERE id=${id}`;
